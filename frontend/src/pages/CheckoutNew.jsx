                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                                ...
                                {Object.entries(deliveryOptions).map(([key, option]) => (
                                    ...
                                    >
                                        ...
                                        <div className={`w-4 h-4 rounded-full border-2 mr-3 ${
                                            deliveryMode === key ? 'border-soni-navy bg-soni-navy' : 'border-gray-300'
                                        }`}>
                                            {deliveryMode === key && (
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-soni-navy to-blue-700 text-white font-bold rounded-lg hover:from-soni-navy/90 hover:to-blue-700/90 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                        >
